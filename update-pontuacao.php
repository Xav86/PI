...
// primeiro colocado
$sql2 = "UPDATE equipes_provas SET equipes_id='$primeiro',pontuacao='$cod1' WHERE provas_id='$numero_prova'";

$res1 = mysqli_query($id, $sql2);
// segundo colocado
$sql2 = "UPDATE equipes_provas SET equipes_id='$segundo',pontuacao='$cod2' WHERE provas_id='$numero_prova'";

$res2 = mysqli_query($id, $sql2);
// terceiro colocado
$sql2 = "UPDATE equipes_provas SET equipes_id='$terceiro',pontuacao='$cod3' WHERE provas_id='$numero_prova'";

$res3 = mysqli_query($id, $sql2);
// quarto colocado
$sql2 = "UPDATE equipes_provas SET equipes_id='$quarto',pontuacao='$cod4' WHERE provas_id='$numero_prova'";

$res4 = mysqli_query($id, $sql2);
//quinto colocado
$sql2 = "UPDATE equipes_provas SET equipes_id='$quinto',pontuacao='$cod5' WHERE provas_id='$numero_prova'";
