                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" >Capitão da Vinculado</th>
                    ...
                    <?php
                        ...
                        while ($linha = mysqli_fetch_array($res)) { 
                            ...
                            <tr>
                                ...
                                <td ><a class="btn btn-warning" href="edit-vinculo.php?id=<?php echo $linha['id']; ?>">Alterar</a></td>
                                <td ><a class="btn btn-danger" href="src/deleta-vinculo.php?id=<?php echo $linha['id']; ?>">Excluir</a></td>
